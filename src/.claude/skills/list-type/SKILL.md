---
name: list-type
description: "Lists type artifacts under src/types matching an optional search term, printing each as id: file path."
---
...
2. **deterministic** — Run .gstudio/artifacts/type/scripts/list/step-2.ts [searchTerm] where searchTerm is an optional string to filter type ids.
