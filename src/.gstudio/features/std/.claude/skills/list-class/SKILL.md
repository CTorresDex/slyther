---
name: list-class
description: "Lists classes defined under src/classes matching an optional search term and prints each as id: file path."
---
...
2. **deterministic** — Run .gstudio/artifacts/class/scripts/list/step-2.sh [search term] to list all classes, optionally filtering to those whose file contents contain the given search term.
