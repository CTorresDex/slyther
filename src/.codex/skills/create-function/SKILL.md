...
description: Scaffolds a new function file at src/functions/{name}.function.ts given a function id and optional initial content, failing if the file already exists.
---
...
2. **deterministic** — Run .gstudio/artifacts/function/scripts/create/step-2.ts <id> to scaffold the function, where <id> is the function's identifier.
