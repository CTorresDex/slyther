---
name: list-class
description: "Lists classes defined under src/classes whose id or path matches an optional search term, printing each as id: file path."
---
...
2. **deterministic** — Run .gstudio/artifacts/class/scripts/list/step-2.ts [searchTerm] to list all classes (optionally filtered to those whose file contents include searchTerm).
