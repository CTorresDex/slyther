---
name: evaluate-class
description: "Checks that a class file matches the required location, shape, and scoping rules for a given class id, printing discrepancies as ERROR_CODE: message and exiting nonzero if any are found."
---
