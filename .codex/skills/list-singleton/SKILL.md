---
name: list-singleton
description: "Lists singletons in the codebase matching an optional search term, printing each as \"[id]: [file path]\"."
---
...
2. **deterministic** — Run .gstudio/artifacts/singleton/scripts/list/step-2.ts [searchTerm] where searchTerm is an optional substring to filter singleton ids by.
