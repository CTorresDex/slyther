---
name: list-function
description: "Lists functions defined under src/functions matching an optional search term and prints each as id: file path."
---
...
2. **deterministic** — Run .gstudio/artifacts/function/scripts/list/step-2.ts [searchTerm] to list all functions in src/functions, optionally filtered to those whose file content contains the given search term.
