...
2. **deterministic** — Run .gstudio/artifacts/class/scripts/update/step-2.sh <id> <change-request> from the project root, where <id> is the class identifier to check.
