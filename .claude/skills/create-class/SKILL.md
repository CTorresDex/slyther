---
name: create-class
description: Scaffolds a new class file at src/src/classes/{Name}.class.ts with a minimal class definition, given an id and optional initial content.
---
...
2. **deterministic** — Run `.gstudio/artifacts/class/scripts/create/step-2.ts <name>` where `<name>` is the class id (any case; it is converted to PascalCase) to scaffold the class file.
