...
description: Scaffolds a new singleton file at src/src/singletons/{name}.singleton.ts with a minimal shared instance, given an id and optional initial content.
---
...
2. **deterministic** — Run .gstudio/artifacts/singleton/scripts/create/step-2.ts <id> to scaffold the singleton, where <id> is the singleton's identifier.
